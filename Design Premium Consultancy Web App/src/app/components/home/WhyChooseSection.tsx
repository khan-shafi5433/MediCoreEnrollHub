...
const features = [
  {
    ...
    description:
      "Our seasoned counselors have guided thousands of students through MBBS admissions at JASU with personalized roadmaps and ongoing mentorship.",
    color: "#0071e3",
    ...
    <section id="why-jasu" className="py-32 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          >
            From your first enquiry to your first day at JASU — we're with you every step of the way.
          </p>
        </motion.div>
