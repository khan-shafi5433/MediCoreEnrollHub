...
import { Send, Paperclip, Smile, Phone, Video, MoreHorizontal, ArrowLeft } from "lucide-react";
...
const initialMessages: Message[] = [
  {
    id: 1,
    sender: "consultant",
    text: "Hello! Welcome to JASU Consultancy. I'm Rahul, your dedicated counselor. How can I help you today?",
    time: "10:32 AM",
  },
  {
    id: 2,
    sender: "user",
    text: "Hi Rahul! I just got my NEET score and I'm interested in MBBS at JASU. Can you help me understand the process?",
    time: "10:33 AM",
    status: "read",
  },
  {
...
export function ChatUI({
  ...
  consultantRole = "Senior Counselor · JASU",
  ...
  const sendMessage = () => {
    ...
    setTimeout(() => {
      ...
      const reply: Message = {
        ...
        text: "Thank you for sharing that! With a score of 420 and Maharashtra domicile, you're well-positioned for JASU. Let me send you the complete document checklist right away.",
        sender: "consultant",
        time: new Date().toLocaleTimeString("en-US", { hour: "2-digit", minute: "2-digit" }),
      };
