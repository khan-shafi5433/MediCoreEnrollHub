...
const contactMethods = [
  {
    icon: MessageCircle,
    label: "WhatsApp",
    value: "+91 95218 04417",
    description: "Available 9am – 9pm IST",
    color: "#25d366",
    bg: "rgba(37,211,102,0.08)",
    href: "https://wa.me/919521804417",
  },
  {
    icon: Mail,
    label: "Email",
    value: "Shaikhjuned1947@gmail.com",
    description: "Reply within 2 hours",
    color: "#0071e3",
    bg: "rgba(0,113,227,0.08)",
    href: "mailto:Shaikhjuned1947@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+91 95218 04417",
    description: "Consultancy Hotline",
    color: "#f59e0b",
    bg: "rgba(245,158,11,0.08)",
    href: "tel:+919521804417",
  },
];
    ...
    <section id="contact" className="py-32 relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          >
            Talk to a senior counselor —  no obligation. We'll answer every question and build your personal admission plan.
          </p>
        </motion.div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  >
                    Available in India, Kyrgyzstan & Online
                  </div>
                  <div
                    style={{
                      fontFamily: "'Inter', sans-serif",
                  ...
                  >
                    Online consultations 24/7 · Offline meetups by appointment
                  </div>
                </div>
              </div>

              <motion.a
                href="https://wa.me/919521804417?text=Hi%2C%20I%20want%20to%20book%20a%20MBBS%20consultation"
                target="_blank"
                rel="noopener noreferrer"
