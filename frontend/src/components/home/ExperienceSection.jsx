...
const slides = [
  {
    ...
    alt: "MediEnroll university campus building",
    tag: "University",
  },
  {
    ...
    description:
      "Set against the breathtaking Kyrgyz landscape, the MediEnroll campus offers modern dormitories, sports facilities, and a vibrant student community from across South Asia.",
    image:
      "https://images.unsplash.com/photo-1523580494863-6f3031224c94?w=900&h=600&fit=crop&auto=format",
  ...
  },
  {
    ...
    description:
      "From Year 2 onwards, students gain clinical exposure in MediEnroll's attached hospitals, working alongside experienced physicians treating a diverse patient population.",
    image:
