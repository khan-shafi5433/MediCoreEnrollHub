...
const testimonials = [
  {
    ...
    year: "MBBS 4th Year",
    text: "MediEnroll Consultancy made the whole process incredibly smooth. From my initial call to landing in Jalal-Abad, they were available 24/7. I couldn't have navigated the visa process alone.",
    rating: 5,
  ...
  },
  {
    ...
    year: "MBBS 3rd Year",
    text: "They handled everything — documents, visa, hostel, even the airport pickup. I just had to show up. The Indian student community at MediEnroll is amazing too!",
    rating: 5,
