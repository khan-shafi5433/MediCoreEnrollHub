...
const faqs = [
  {
    question: "Is MediEnroll recognized by MCI / NMC and WHO?",
    answer:
  ...
  {
    question: "What is the duration of the MBBS program at MediEnroll?",
    answer:
      "The MBBS program at MediEnroll is 5 years of academic study followed by 1 year of compulsory rotating internship, totaling 6 years. Teaching is conducted in English, making it accessible for Indian students without a language barrier.",
  },
  {
  ...
  {
    question: "Is NEET mandatory to study MBBS at MediEnroll?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Kyrgyzstan is a peaceful, politically stable country and is one of the safest Central Asian nations. The city of Jalal-Abad has a large, well-established Indian student community. MediEnroll has dedicated Indian student coordinators, Indian mess facilities, and a 24/7 helpline for student safety.",
  },
  {
    question: "What kind of support does MediEnroll Consultancy provide after admission?",
    answer:
